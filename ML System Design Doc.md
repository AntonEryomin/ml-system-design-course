...
- Бизнес цель - уменьшить время и ресурсы, потраченные на подбор кандидатов для вакансии, повысив качество подбора, используя ML модель.
- Текущий процесс подбора кандидатов на вакансии требует значительных усилий от HR-специалистов.
- Почему станет лучше: сейчас рекрутер ищет подходящего кандидата на работных сайтах по названию должности и дополнительнх фильтров, набору ключевых слов и опыту. Тем не менее, резюме содержит гораздо больше полезной информации, которую использует HR-специалист при скрининге резюме.
- Использование умного алгоритма матчинга позволит предлагать более подходящего кандидата.
###### Что считать успехом итерации
-  Уменьшение времени, затраченного HR-специалистом, на просмотр резюме на 30%, благодаря более точному, автоматическому предварительному отбору

#### 1.2. Бизнес-требования и ограничения  

###### Краткое описание БТ
- Система должна автоматически выдавать рекомендации кандидатов на определеные вакансии
- Система должна предлагать рекомендации, с точностью не менее X% (EDA), минимизируя количество неудачных рекомендаций
- Система должна позволять интеграцию с базами данных резюме
- Удобеный и интуитивно понятный интерфейс для HR-специалистов
- Защита данных кандидатов и гарантирование их конфиденциальность
- Способность системы адаптироваться к росту числа вакансий и кандидатов  

###### Бизнес-ограничения `Product Owner`
- Время разработки ограничено до 12 декабря
- Расходы на разработку, майнинг данных, внедрение не должны превышать X рублей
- Система должна соответствовать требованиям законодательства о защите личных данных
- Масштабируемость должна быть экономически эффективной

##### Технические ограничения
- Время на обработку 1 вакансии не должно превышать 15 минут
- Время на обработку 100 вакансий не должно превышать 100 минут
  
#### Что мы ожидаем от конкретной итерации
##### Исследование
- Узнать текушщие подходы к решению задач CV-матчинга
- Сформировать требования к модели
- Проанализировать доступные датасеты для обучения модели и найти способы получения разметки
- Реализовать бейзлайн
- Определиться с задачей, архитектурой модели и способом ее обучения

##### Разработка
- Разработка бэкэнда, позволяющего загружать данные и делать рекомендации, с помощью умного алгортма (безлайн/целевая ML-модель)
- Разработка фронтэнда - интерфейса для HR-специалистов
- Обучение модели

##### Внедрение
- Создать тестовое окружение
- Создать docker образ системы
- Тестирование
...
- Выбор целевой группы HR-специалситов
- Интеграция модели в существующую систему HR
- Обучение HR-специалистов
- Сбор обратной связи от HR-специалистов
- Анализ результатов
- Оценка результатов того, как модель влияет на скорость и качество работы HR-специалистов
  
##### Что считаем успешным пилотом? Критерии успеха и возможные пути развития проекта `Product Owner`
- Улучшение эффективности отбора на 5%
